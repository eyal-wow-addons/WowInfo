...
local frame = CreateFrame("Frame", "WowInfo_DurabilityFrame")
...
function Durability:GetInventoryPercentageText()
    return inventoryPct and GetColoredText(inventoryPct) or NA_LABEL
end

function Durability:GetBagsPercentageText()
